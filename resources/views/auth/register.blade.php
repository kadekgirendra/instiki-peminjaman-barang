<x-guest-layout>
    <h1 class="text-3xl font-bold text-secondary">Buat Akun</h1>
    ...
    <form method="POST" action="{{ route('register') }}" class="space-y-5">
        ...
        <div>
            ...
            <input type="text" name="name" value="{{ old('name') }}" placeholder="Masukan nama lengkap"
                class="w-full rounded-lg border border-slate-200 bg-slate-50 px-4 py-3 focus:outline-none focus:ring-2 focus:ring-primary">
        </div>

        <div>
            <label class="block font-semibold text-secondary mb-1">NIM</label>
            <input type="text" name="nim_nidn" value="{{ old('nim_nidn') }}" placeholder="Masukan NIM"
                class="w-full rounded-lg border border-slate-200 bg-slate-50 px-4 py-3 focus:outline-none focus:ring-2 focus:ring-primary">
        </div>
